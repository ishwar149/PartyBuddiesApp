...
namespace PartyBuddiesApp.ViewModels.Forms
{
    ...
    public class AddPartyPageViewModel : BaseViewModel
    {
        #region Fields
        ...
        #region constructor
        public AddPartyPageViewModel()
        {
            App.MessageStatus = 4.7;
            ...
            this.AddParty = new Command(this.AddPartyClicked);
        ...
        private async void AddPartyClicked(object obj)
        {
            AddEnabled = false;
